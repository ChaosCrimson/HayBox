...
GpioButtonMapping button_mappings[] = {
    {&InputState::l,            17 },            //default 5, L
    { &InputState::left,        5 },            //default 4, left
    { &InputState::down,        3 },            //default 3, down
    { &InputState::right,       2 },            //default 2, right

    { &InputState::mod_x,       6 },            //default 6
    { &InputState::mod_y,       7 },            //default 7

    { &InputState::select,      10},            //default 10
    { &InputState::start,       0 },            //default 0
    { &InputState::home,        11},            //default 11

    { &InputState::c_left,      13},            //default 13
    { &InputState::c_up,        12},            //default 12
    { &InputState::c_down,      15},            //default 15
    { &InputState::a,           14},            //default 14
    { &InputState::c_right,     16},            //default 16

    { &InputState::b,           26},            //default 26
    { &InputState::x,           21},            //default 21
    { &InputState::z,           19},            //default 19
    { &InputState::up,          4},            //default 17, up

    { &InputState::r,           27},            //default 27
    { &InputState::y,           22},            //default 22
    { &InputState::lightshield, 20},            //default 20
    { &InputState::midshield,   18},            //default 18
};
...
void setup() {
    ...
    if (console == ConnectedConsole::NONE) {
        if (button_holds.x) {
            ...
            primary_backend->SetGameMode(new Ultimate(socd::SOCD_2IP_NO_REAC));
            return;
